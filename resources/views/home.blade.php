    ...
    <div class = 'innershadow' style = 'background-color:{{$styleCode["1"]}}; margin-top:-1.75em;'> 
        ...
        <div class="">
          ...
          <div class="row">
            ...
            <div style = 'margin-top:2em;margin-right:1em;margin-left:0.75em;margin-bottom:2em;max-width:25%;min-width:15em;' class="col-md-2 grad10 shadow">
                    		...
                    		<div style = 'padding-top:4em;' class="col text-center mtoph pbottom mbottomh innershadow">
                     		...
                     		@if(@Auth::user()->level > 0)
        						<div>
                                    ...
                                    <form id = 'bioform' action="/home/bio" method='POST'>
                                      {{ csrf_field() }}
        ...
        <script>
        	...
        	$(document).on('change', '#biochange', function () {
            ...
            $(document).on('click', '#biosave', function () {
