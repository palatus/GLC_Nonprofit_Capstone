...
<div style= 'font-size:1.25em; color:white; padding-top:2em; width:75%;' class="container">
         	...
         	<div class = ''>
         		...
         		<div>
            		...
            		<div class="col text-center mtoph pbottom mbottomh">
            			<div class = "box imgBg innershadow" id = 'userIcon' style = "padding-top:1em;background-image: url('/images/user/{{Auth::user()->iconId}}');">
                    		<div  class="text-center">
                          					
									<form class = 'invisible' id = 'iconForm' action="/home/icon" enctype='multipart/form-data' method='POST'>
                                    	{{ csrf_field() }}
         			...
         			<div>
             			<div>
             				...
             				@else
             					<span style = 'color:lime;'>Verified</span>
             				@endif
                    ...
                    <div style = 'padding-top:0.5em;margin-top:4em;' class = 'btn btn-success'>
                    	...
                    	<form id="logout-form" action="{{ route('logout') }}" accept=".png,.jpg,.jpeg" method="POST" style="display: none;">
                    		{{ csrf_field() }}
                    	</form>
                    </div>		
...
<script>
	...
	@endif
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '#iconUpload', function () {
